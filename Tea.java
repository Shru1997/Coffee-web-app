...
public class Tea extends JFrame {
	...
	public static Tea frame = new  Tea();
	...
	public Tea() {
		...
		btnNewButton.setBounds(138, 153, 57, 51);
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			//	String COFFEE= txtbyrtText().toString().toLowerCase();
				...
				String prefix = "prefix hc: <" + COFFEE_NS + ">\n" +
				...
				" SELECT  ?name ?Flavour  \r\n"  +
						" WHERE { ?x a hc:Tea.  ?x hc:name ?name. ?x hc:Flavour ?Flavour\r\n ";
		...
		JLabel lblCake = new JLabel("TEA");
		lblCake.setFont(new Font("Tahoma", Font.BOLD, 20));
		lblCake.setBounds(485, 23, 79, 36);
		contentPane.add(lblCake);
		
		JLabel lblNewLabel = new JLabel("New label");
		lblNewLabel.setIcon(new ImageIcon("C:\\Users\\Shruthi\\Desktop\\images\\tea.JPG"));
		lblNewLabel.setBounds(10, 11, 368, 222);
